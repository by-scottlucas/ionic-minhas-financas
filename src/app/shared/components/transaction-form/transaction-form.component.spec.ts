...
import { CardTypeEnum } from 'src/app/features/card/models/card-type.enum';
...
import { LIST_CARDS_MOCK } from 'src/app/shared/testing/card-mocks';
import { CREATE_TRANSACTION_MOCK } from 'src/app/shared/testing/transaction-mocks';
import { TransactionService } from 'src/app/features/wallet/services/wallet.service';
